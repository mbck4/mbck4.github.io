        ...
        towns.forEach(
            town => {
                if (town.name === 'Preston') {
                    ...
                    document.querySelector('#prestonAnnualRainfall').textContent = `Annual Rain Fall: ${town.averageRainfall}`;
                    ...
                    document.querySelector('#sodaSpringsAnnualRainfall').textContent = `Annual Rain Fall: ${town.averageRainfall}`;
                    ...
                    document.querySelector('#fishHavenAnnualRainfall').textContent = `Annual Rain Fall: ${town.averageRainfall}`;
